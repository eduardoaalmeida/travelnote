...
|---|---|---|---|
| **Eduardo Andrade** | • Tela de carregamento <br> • Tela de Login <br> • Tela de Cadastro <br> • Termos de Privacidade <br> <br> • Recuperar Senha | • Aplicativo abrir corretamente <br> • Realizar login <br> • Realizar cadastro <br> • Visualizar termos de privacidade <br> • Solicitar recuperação de senha | https://youtu.be/rioHryIgDr8 <br>
